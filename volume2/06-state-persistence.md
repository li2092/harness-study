...
> v1.0 · 2026-07-23 · 依据 SPEC.md §十三 章 spec（统一语言冻结章：实体链＋四条全局规则＋SSOT/投影＋四项边界＋三生命周期＋Belief/World Model；章节引用文字化首个执行章）· 四维评审四路已落实 · **用户过审（2026-07-23，"继续"；Attempt 不设实体、lease 分层两项裁决随过审确认；章题维持原名；model-based harness 实名悬案留档待终稿）**
