...
> 覆盖范围：随各章过审增量维护。**一、概念主线索引已覆盖全卷第一至十五章**（2026-07-26 回填）；二、术语速查／三、探针与观测点／四、字段字典导览／五、图表清单仍只覆盖第一至九章，第十至十五章待补（维护规则见各节末）。
...
这条线专治"崩溃/挂起/分叉恢复后把旧授权一起搭车恢复"这一族缺陷。第七章 7.8 立铁律、第十一章 11.6 收口，中间六站各补一个恢复入口。
