...
> **概念图解形态（2026-07-23 定）**：第二卷核心概念用"图＋前因后果（场景／症结／机制／结果）"的卡片呈现，形态样张见 `concept-diagram-sample.html`（投影不是真相／四段账／fencing 编号三例）。**PDF 出版阶段**按此把核心概念逐个图解化、统一细化；markdown 写作阶段不铺开画图。下方"二、术语速查"是同批概念的文字索引版，与图解卡片以概念为单位对应。
